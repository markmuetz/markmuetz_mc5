...
\begin{figure}[htp!]%
    \centering
    \subfloat[label 1]{{\includegraphics[width=7cm]{figs/atmos_S0_1km_cloud_tracking_z1_t1_all_lifetimes.png} }}%
    \qquad
    \subfloat[label 1]{{\includegraphics[width=7cm]{figs/atmos_S0_1km_cloud_tracking_z1_t1_nonlinear_lifetimes.png} }}%
    \qquad
    \subfloat[label 1]{{\includegraphics[width=7cm]{figs/atmos_S4_1km_cloud_tracking_z1_t1_all_lifetimes.png} }}%
    \qquad
    \subfloat[label 1]{{\includegraphics[width=7cm]{figs/atmos_S4_1km_cloud_tracking_z1_t1_nonlinear_lifetimes.png} }}%
